...
M.git = function()
  ...
  local added = (git_status.added and git_status.added ~= 0) and ("%#St_pos_text#" .. "  " .. git_status.added) or ""
  local changed = (git_status.changed and git_status.changed ~= 0) and ("%#St_lspHints#" .. "  " .. git_status.changed) or ""
  local removed = (git_status.removed and git_status.removed ~= 0) and ("%#St_lspError#" .. "  " .. git_status.removed) or ""
  local branch_name = "%#St_LspStatus#" .. "  " .. git_status.head
...
M.LSP_Diagnostics = function()
  ...
  Errors = (errors and errors > 0) and ("%#St_lspError#" .. "󰈸 " .. errors .. " ") or ""
  Warnings = (warnings and warnings > 0) and ("%#St_lspWarning#" .. "󱗗 " .. warnings .. " ") or ""
...
M.cursor_position = function()
  ...
  local text2 = current_line .. " of " .. total_line  -- current / all

  return left_sep .. "%#St_pos_text#" .. " " .. text2 .. " "
end
