...
M.lazy = function(install_path)
  ...
  local base46_repo = "https://ghproxy.com/https://github.com/NvChad/base46"
  ...
  local repo = "https://ghproxy.com/https://github.com/folke/lazy.nvim.git"
...
M.gen_chadrc_template = function()
  ...
  if fn.isdirectory(path) ~= 1 then
    ...
    if input:lower() == "y" then
      ...
      shell_call { "git", "clone", "--depth", "1", "https://ghproxy.com/https://github.com/NvChad/example_config", path }
